...
// ./features/user/admin-user-detail.tsx
...
type Module = typeof import("../admin-user-detail.js")

export type Info = {
  parents: [Parent0, Parent1],
  id: "features/user/admin-user-detail"
  file: "./features/user/admin-user-detail.tsx"
  path: "admin/users/:id/*"
  params: {"id": string; "*": string} & { [key: string]: string | undefined }
  module: Module
